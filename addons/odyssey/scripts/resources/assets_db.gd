...
func reload() -> void:
	...
	_scan_dirs(scenes, ["res://scenes/", "res://addons/odyssey/scenes"], [ "tscn", "scn" ])
...
func _scan_dirs(paths: Dictionary[StringName, String], dirs: Array[String], ext: Array[String]) -> void:
	for dir in dirs:
		_scan_dir(paths, dir, dir, ext)

func _scan_dir(paths: Dictionary[StringName, String], head: String, dir: String, ext: Array[String] = []) -> void:
